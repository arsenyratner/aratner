...
/ip address add address=172.26.71.15/24 interface=ether2
...
:global LANIFNAME "$LANIFDEFAULTNAME-LAN-15";
:global IDENTITY "i-rt15";
:global USERNAME "aratner";
:global LANIPADDR "172.28.15.1";
:global LANIPMASK "24";
...
/ip firewall address-list add address=172.26.71.14 list=trusted
/ip firewall address-list add address=172.26.71.15 list=trusted
...
/ip firewall address-list add address=172.28.14.0/24 list=trusted
/ip firewall address-list add address=172.28.15.0/24 list=trusted
